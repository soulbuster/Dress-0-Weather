...
function b(p){for(var q=g,r=0;64>r;r+=4)q[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=q[r-3]^q[r-8]^q[r-14]^q[r-16],q[r]=(p<<1|p>>>31)&4294967295;p=e[0];var w=e[1],y=e[2],C=e[3],U=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var M=C^w&(y^C);var Y=1518500249}else M=w^y^C,Y=1859775393;else 60>r?(M=w&y|C&(w|y),Y=2400959708):(M=w^y^C,Y=3395469782);M=((p<<5|p>>>27)&4294967295)+M+U+Y+q[r]&4294967295;U=C;C=y;y=(w<<30|w>>>2)&4294967295;w=p;p=M}e[0]=e[0]+p&4294967295;e[1]=e[1]+w&4294967295;e[2]=
e[2]+y&4294967295;e[3]=e[3]+C&4294967295;e[4]=e[4]+U&4294967295}
...
;function Vf(a){var b=Wf;a=void 0===a?B("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=Nc;e.flash="0";a:{try{var f=b.h.top.location.href}catch(U){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?L:g;try{var h=g.history.length}catch(U){h=0}e.u_his=h;e.u_java=!!L.navigator&&"unknown"!==typeof L.navigator.javaEnabled&&!!L.navigator.javaEnabled&&L.navigator.javaEnabled();L.screen&&(e.u_h=L.screen.height,e.u_w=L.screen.width,
e.u_ah=L.screen.availHeight,e.u_aw=L.screen.availWidth,e.u_cd=L.screen.colorDepth);L.navigator&&L.navigator.plugins&&(e.u_nplug=L.navigator.plugins.length);L.navigator&&L.navigator.mimeTypes&&(e.u_nmime=L.navigator.mimeTypes.length);h=b.h;try{var k=h.screenX;var l=h.screenY}catch(U){}try{var n=h.outerWidth;var p=h.outerHeight}catch(U){}try{var q=h.innerWidth;var r=h.innerHeight}catch(U){}k=[h.screenLeft,h.screenTop,k,l,h.screen?h.screen.availWidth:void 0,h.screen?h.screen.availTop:void 0,n,p,q,r];
l=b.h.top;try{var w=(l||window).document,y="CSS1Compat"==w.compatMode?w.documentElement:w.body;var C=(new xc(y.clientWidth,y.clientHeight)).round()}catch(U){C=new xc(-12245933,-12245933)}w=C;C={};y=new Zc;z.SVGElement&&z.document.createElementNS&&y.set(0);l=Jc();l["allow-top-navigation-by-user-activation"]&&y.set(1);l["allow-popups-to-escape-sandbox"]&&y.set(2);z.crypto&&z.crypto.subtle&&y.set(3);z.TextDecoder&&z.TextEncoder&&y.set(4);y=$c(y);C.bc=y;C.bih=w.height;C.biw=w.width;C.brdim=k.join();b=
...
(b["X-YouTube-Time-Zone"]=g)}if(c||!Ub(a))b["X-YouTube-Ad-Signals"]=Sf(Vf(void 0));return b}
...
;var T=B("ytglobal.prefsUserPrefsPrefs_")||{};A("ytglobal.prefsUserPrefsPrefs_",T,void 0);function fh(){this.h=I("ALT_PREF_COOKIE_NAME","PREF");this.i=I("ALT_PREF_COOKIE_DOMAIN","youtube.com");var a=Vc.get(""+this.h,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(T[d]=c.toString())}}}
fh.prototype.get=function(a,b){gh(a);hh(a);var c=void 0!==T[a]?T[a].toString():null;return null!=c?c:b?b:""};
fh.prototype.set=function(a,b){gh(a);hh(a);if(null==b)throw Error("ExpectedNotNull");T[a]=b.toString()};
fh.prototype.remove=function(a){gh(a);hh(a);delete T[a]};
fh.prototype.clear=function(){for(var a in T)delete T[a]};
...
function ih(a){a=void 0!==T[a]?T[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
...
;var Lh=new ph("ytidb");function Mh(a,b,c){this.i=void 0===a?!1:a;this.failureMessage=b;this.j=c;this.h=Lh.get("LAST_RESULT_ENTRY_KEY",!0);this.h||(this.h={createdTimestampMs:S(),isSupported:this.i,resultCount:0});if(Nh()){var d;this.h.isSupported===this.i?d=Object.assign(Object.assign({},this.h),{resultCount:this.h.resultCount+1}):d={isSupported:this.i,resultCount:1,createdTimestampMs:S()};Lh.set("LAST_RESULT_ENTRY_KEY",d,2592E3,!0)}}
function Oh(a,b){return new Mh(!1,a instanceof Error?a.message:"",void 0===b?!1:b)}
Mh.prototype.isSupported=function(){return this.i};
Mh.prototype.log=function(){Nh()&&Kh("IS_SUPPORTED_COMPLETED",{isSupported:this.i,lastIsSupported:this.h.isSupported,failureMessage:this.failureMessage,sameResultCount:this.h.resultCount,sameResultDurationMs:Math.floor(S()-this.h.createdTimestampMs),canDetectDataOnFailure:this.j})};
function Nh(){return Q("ytidb_analyze_is_supported")&&!!Lh.h}
...
v(V,Error);function Ph(a){return a.substr(0,a.indexOf(":"))||a}
...
"Can't start a transaction on a closed database",Qh),Sh={},Th=(Sh.AUTH_INVALID="ERROR",Sh.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",Sh.EXPLICIT_ABORT="IGNORED",Sh.IDB_NOT_SUPPORTED="ERROR",Sh.MISSING_OBJECT_STORE="ERROR",Sh.QUOTA_EXCEEDED="WARNING",Sh.QUOTA_MAYBE_EXCEEDED="WARNING",Sh.UNKNOWN_ABORT="WARNING",Sh);
function W(a,b,c,d){b=void 0===b?{}:b;c=void 0===c?Rh[a]:c;d=void 0===d?Th[a]:d;V.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;Object.setPrototypeOf(this,W.prototype)}
v(W,V);function Uh(a){W.call(this,"MISSING_OBJECT_STORE",{xk:a},Rh.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Uh.prototype)}
v(Uh,W);var Vh=["The database connection is closing","Can't start a transaction on a closed database","A mutation operation was attempted on a database that did not allow mutations"];
function Wh(a,b,c){b=Ph(b);var d=a instanceof Error?a:Error("Unexpected error: "+a);if(d instanceof W)return d;if("QuotaExceededError"===d.name)return new W("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(rc&&"UnknownError"===d.name)return new W("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if("InvalidStateError"===d.name&&Vh.some(function(e){return d.message.includes(e)}))return new W("EXECUTE_TRANSACTION_ON_CLOSED_DB",{objectStoreNames:c,
...
X.all=function(a){return new X(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={R:0};f.R<a.length;f={R:f.R},++f.R)Zh(X.resolve(a[f.R]).then(function(g){return function(h){d[g.R]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
...
X.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:Yh,e=null!==b&&void 0!==b?b:Xh;return new X(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){$h(c,c,d,f,g)}),c.onRejected.push(function(){ai(c,c,e,f,g)})):"FULFILLED"===c.state.status?$h(c,c,d,f,g):"REJECTED"===c.state.status&&ai(c,c,e,f,g)})};
function Zh(a,b){a.then(void 0,b)}
function $h(a,b,c,d,e){try{if("FULFILLED"!==a.state.status)throw Error("calling handleResolve before the promise is fulfilled.");var f=c(a.state.value);f instanceof X?bi(a,b,f,d,e):d(f)}catch(g){e(g)}}
function ai(a,b,c,d,e){try{if("REJECTED"!==a.state.status)throw Error("calling handleReject before the promise is rejected.");var f=c(a.state.reason);f instanceof X?bi(a,b,f,d,e):d(f)}catch(g){e(g)}}
function bi(a,b,c,d,e){b===c?e(new TypeError("Circular promise chain detected.")):c.then(function(f){f instanceof X?bi(a,b,f,d,e):d(f)},function(f){e(f)})}
...
function ei(a){return new X(function(b,c){ci(a,b,c)})}
;function fi(a,b){return new X(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()})}
;function gi(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(S());this.i=!1}
m=gi.prototype;m.add=function(a,b,c){return hi(this,[a],{mode:"readwrite",U:Q("ytidb_transaction_enable_retries_core_and_nwl")},function(d){return ii(d,a).add(b,c)})};
m.clear=function(a){return hi(this,[a],{mode:"readwrite",U:Q("ytidb_transaction_enable_retries_core_and_nwl")},function(b){return ii(b,a).clear()})};
m.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
m.count=function(a,b){return hi(this,[a],{mode:"readonly",U:Q("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return ii(c,a).count(b)})};
m["delete"]=function(a,b){return hi(this,[a],{mode:"readwrite",U:Q("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return ii(c,a)["delete"](b)})};
m.get=function(a,b){return hi(this,[a],{mode:"readonly",U:Q("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return ii(c,a).get(b)})};
function hi(a,b,c,d){return Zb(a,function f(){var g=this,h,k,l,n,p,q,r,w,y,C,U;return xa(f,function(M){switch(M.h){case 1:var Y={mode:"readonly",U:!1};"string"===typeof c?Y.mode=c:Y=c;h=Y;g.transactionCount++;k=h.U?nf("ytidb_transaction_try_count",1):1;case 2:if(l){M.h=3;break}k--;n=Math.round(S());M.j=4;p=g.h.transaction(b,h.mode);Y=new ji(p);Y=ki(Y,d);return x(M,Y,6);case 6:return q=M.i,r=Math.round(S()),li(g,n,r,void 0,b.join(),h),M["return"](q);case 4:w=ra(M);y=Math.round(S());C=Wh(w,g.h.name,
b.join());if((U=C instanceof W&&"EXPLICIT_ABORT"===C.type)||0>=k)li(g,n,y,C,b.join(),h),l=C;M.h=2;break;case 3:return M["return"](Promise.reject(l))}})})}
function li(a,b,c,d,e,f){b=c-b;d?(d instanceof W&&("QUOTA_EXCEEDED"===d.type||"QUOTA_MAYBE_EXCEEDED"===d.type)&&Kh("QUOTA_EXCEEDED",{dbName:Ph(a.h.name),objectStoreNames:e,transactionCount:a.transactionCount,transactionMode:f.mode}),d instanceof W&&"UNKNOWN_ABORT"===d.type&&(Kh("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:e,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c-a.j}),a.i=!0),mi(a,!1,e,b),Jh||(Ih.push({type:"ERROR",payload:d}),10<Ih.length&&Ih.shift())):mi(a,
!0,e,b)}
function mi(a,b,c,d){Kh("TRANSACTION_ENDED",{objectStoreNames:c,connectionHasUnknownAbortedTransaction:a.i,duration:d,isSuccessful:b})}
function ni(a){this.h=a}
m=ni.prototype;m.add=function(a,b){return ei(this.h.add(a,b))};
...
m["delete"]=function(a){return a instanceof IDBKeyRange?oi(this,a):ei(this.h["delete"](a))};
m.get=function(a){return ei(this.h.get(a))};
m.index=function(a){return new qi(this.h.index(a))};
m.getName=function(){return this.h.name};
function pi(a,b,c){a=a.h.openCursor(b.query,b.direction);return ri(a).then(function(d){return fi(d,c)})}
...
function ki(a,b){var c=new Promise(function(d,e){Zh(b(a).then(function(f){a.commit();d(f)}),e)});
return Promise.all([c,a.done]).then(function(d){return u(d).next().value})}
ji.prototype.abort=function(){this.h.abort();this.aborted=!0;throw new W("EXPLICIT_ABORT");};
ji.prototype.commit=function(){var a=this.h;a.commit&&!this.aborted&&a.commit()};
function ii(a,b){var c=a.h.objectStore(b),d=a.i.get(c);d||(d=new ni(c),a.i.set(c,d));return d}
function qi(a){this.h=a}
qi.prototype.count=function(a){return ei(this.h.count(a))};
qi.prototype["delete"]=function(a){return si(this,{query:a},function(b){return b["delete"]().then(function(){return b["continue"]()})})};
qi.prototype.get=function(a){return ei(this.h.get(a))};
qi.prototype.getKey=function(a){return ei(this.h.getKey(a))};
function si(a,b,c){a=a.h.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return ri(a).then(function(d){return fi(d,c)})}
function ti(a,b){this.request=a;this.cursor=b}
function ri(a){return ei(a).then(function(b){return null===b?null:new ti(a,b)})}
...
m.update=function(a){return ei(this.cursor.update(a))};function ui(a,b,c){return Zb(this,function e(){var f,g,h,k,l,n,p,q,r,w;return xa(e,function(y){if(1==y.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.fb,n=g.upgrade,p=g.closed,r=function(){q||(q=new gi(f.result,{closed:p}));return q},f.addEventListener("upgradeneeded",function(C){if(null===C.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");C.dataLoss&&"none"!==C.dataLoss&&Kh("IDB_DATA_CORRUPTED",{reason:C.dataLossMessage||"unknown reason",dbName:Ph(a)});var U=r(),M=new ji(f.transaction);n&&n(U,C.oldVersion,C.newVersion,M)}),h&&f.addEventListener("blocked",function(){h()}),x(y,di(f),2);
w=y.i;k&&w.addEventListener("versionchange",function(){k(r())});
w.addEventListener("close",function(){Kh("IDB_UNEXPECTEDLY_CLOSED",{dbName:Ph(a),dbVersion:w.version});l&&l()});
return y["return"](r())})})}
function vi(a,b){b=void 0===b?{}:b;return Zb(this,function d(){var e,f,g;return xa(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
return x(h,di(e),0)})})}
;function wi(a){this.name="YtIdbMeta";this.options=a;this.i=!1}
function xi(a,b,c){c=void 0===c?{}:c;c=void 0===c?{}:c;return ui(a,b,c)}
...
closed:c,fb:c,upgrade:this.options.upgrade},e=function(){return Zb(a,function g(){var h=this,k,l,n;return xa(g,function(p){switch(p.h){case 1:return p.j=2,x(p,xi(h.name,h.options.version,d),4);case 4:k=p.i;a:{var q=u(Object.keys(h.options.Ra));for(var r=q.next();!r.done;r=q.next())if(r=r.value,!k.h.objectStoreNames.contains(r)){q=r;break a}q=void 0}l=q;if(void 0===l){p.h=5;break}if(h.i){p.h=6;break}h.i=!0;return x(p,h["delete"](),7);case 7:return p["return"](e());case 6:throw new Uh(l);case 5:return p["return"](k);
case 2:n=ra(p);if(n instanceof DOMException?"VersionError"===n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"===n.name:n instanceof Object&&"message"in n&&"An attempt was made to open a database using a lower version than the existing version."===n.message)return p["return"](xi(h.name,void 0,Object.assign(Object.assign({},d),{upgrade:void 0})));c();throw n;}})})};
this.h=b=e()}return this.h};var yi=new wi({Ra:{databases:!0},upgrade:function(a,b){1>b&&a.h.createObjectStore("databases",{keyPath:"actualName"})}});
function zi(a){return Zb(this,function c(){var d;return xa(c,function(e){if(1==e.h)return x(e,yi.open(),2);d=e.i;return e["return"](hi(d,["databases"],"readwrite",function(f){var g=ii(f,"databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier||a.clearDataOnAuthChange!==h.clearDataOnAuthChange:1)return ei(g.h.put(a,void 0)).then(function(){})})}))})})}
function Ai(){return Zb(this,function b(){var c;return xa(b,function(d){if(1==d.h)return x(d,yi.open(),2);c=d.i;return d["return"](c["delete"]("databases","yt-idb-test-do-not-use"))})})}
function Bi(){return Zb(this,function b(){var c,d;return xa(b,function(e){if(1==e.h)return x(e,yi.open(),2);if(3!=e.h)return c=e.i,x(e,c.count("databases"),3);d=e.i;return e["return"](0<d)})})}
;var Ci;
function Di(){return Zb(this,function b(){var c,d,e,f;return xa(b,function(g){switch(g.h){case 1:var h;if(h=ng)h=/WebKit\/([0-9]+)/.exec(Ib),h=!!(h&&600<=parseInt(h[1],10));h&&(h=/WebKit\/([0-9]+)/.exec(Ib),h=!(h&&602<=parseInt(h[1],10)));if(h)return g["return"](Oh(Error("YtIdb is not supported on iOS 8 or 9")));if(dc)return g["return"](Oh(Error("YtIdb is not supported on Edge")));try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return g["return"](Oh(Error("Non-prefixed indexedDB APIs are missing")))}catch(k){return g["return"](Oh(k))}if(!("IDBTransaction"in self&&
"objectStoreNames"in IDBTransaction.prototype))return g["return"](Oh(Error("IDBTransaction.prototype.objectStoreNames is missing")));g.j=2;d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return x(g,zi(d),4);case 4:return x(g,Ai(),5);case 5:return g["return"](new Mh(!0));case 2:e=ra(g);if(!Nh()){g.h=6;break}g.j=7;return x(g,Bi(),9);case 9:return f=g.i,g["return"](Oh(e,f));case 7:return ra(g),g["return"](Oh(e));case 6:return g["return"](Oh(e))}})})}
function Ei(){if(void 0!==Ci)return Ci;Jh=!0;return Ci=Di().then(function(a){Jh=!1;a.log();return a.isSupported()})}
;var Fi;function Gi(){Fi||(Fi=new ph("yt.offline"));return Fi}
;function Hi(){ke.call(this);this.o=this.A=this.C=this.l=!1;this.j=Ii();this.o=Q("validate_network_status");Ji(this);Ki(this)}
v(Hi,ke);function Ii(){var a=window.navigator.onLine;return void 0===a?!0:a}
function Ki(a){window.addEventListener("online",function(){return Zb(a,function c(){var d=this;return xa(c,function(e){if(1==e.h){if(!d.o){d.j=!0;e.h=2;return}return x(e,Li(d),3)}2!=e.h&&(d.j=e.i);d.l&&d.j&&le(d,"ytnetworkstatus-online");Mi(d);if(d.A&&Q("offline_error_handling")){var f=Gi().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new V(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;hf(h)}Gi().set("errors",{},2592E3,!0)}}e.h=0})})})}
function Ji(a){window.addEventListener("offline",function(){return Zb(a,function c(){var d=this;return xa(c,function(e){if(1==e.h){if(!d.o){d.j=!1;e.h=2;return}return x(e,Li(d),3)}2!=e.h&&(d.j=e.i);d.l&&!d.j&&le(d,"ytnetworkstatus-offline");Mi(d);e.h=0})})})}
function Mi(a){a.C&&(jf(new V("NetworkStatusManager state did not match poll",S()-0)),a.C=!1)}
function Li(a){return Zb(a,function c(){var d;return xa(c,function(e){switch(e.h){case 1:return e.j=2,x(e,fetch("/generate_204",{method:"HEAD"}),4);case 4:d=!0;e.h=3;e.j=0;break;case 2:ra(e),d=!1;case 3:return e["return"](d)}})})}
;function Ni(a){a=void 0===a?{}:a;ke.call(this);var b=this;this.l=this.A=0;Hi.h||(Hi.h=new Hi);this.j=Hi.h;this.j.l=!0;a.Qa&&(this.j.A=!0);a.ea?(this.ea=a.ea,be(this.j,"ytnetworkstatus-online",function(){Oi(b,"publicytnetworkstatus-online")}),be(this.j,"ytnetworkstatus-offline",function(){Oi(b,"publicytnetworkstatus-offline")})):(be(this.j,"ytnetworkstatus-online",function(){le(b,"publicytnetworkstatus-online")}),be(this.j,"ytnetworkstatus-offline",function(){le(b,"publicytnetworkstatus-offline")}))}
v(Ni,ke);function Oi(a,b){a.ea?a.l?(Ef(a.A),a.A=Bf(function(){a.o!==b&&(le(a,b),a.o=b,a.l=S())},a.ea-(S()-a.l))):(le(a,b),a.o=b,a.l=S()):le(a,b)}
;var Pi;function Qi(a,b){b=void 0===b?{}:b;Ei().then(function(){Pi||(Pi=new Ni({Qa:!0}));Pi.j.j!==Ii()&&jf(new V("NetworkStatusManager isOnline does not match window status"));hg(a,b)})}
function Ri(a,b){b=void 0===b?{}:b;Ei().then(function(){hg(a,b)})}
;function Si(a){var b=this;this.h=null;a?this.h=a:mh()&&(this.h=Yg());Cf(function(){uh(b)},0,5E3)}
Si.prototype.isReady=function(){!this.h&&mh()&&(this.h=Yg());return!!this.h};
...
groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}}];function Vi(){this.h=[];this.i=[]}
var Wi;function Xi(){Wi||(Wi=new Vi);return Wi}
...
;function aj(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=bj(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=e;var g=a[e],h=b,k=c;f="string"!==typeof g||"clickTrackingParams"!==f&&"trackingParams"!==f?0:(g=Zi(atob(g.replace(/-/g,"+").replace(/_/g,"/"))))?bj(f+".ve",g,h,k):0;d+=f;d+=bj(e,a[e],b,c);if(500<d)break}}else c[b]=cj(a),d+=c[b].length;else c[b]=cj(a),d+=c[b].length;return d}
...
;var dj=new Set,ej=0,fj=0,gj=0,hj=[],ij=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function jj(a){kj(a,"WARNING")}
...
d.push("Stacktrace: "+a.stack),window.console.log(d.join("\n"),a)),!(5<=ej))){var g=rd(a);d=g.message||"Unknown Error";e=g.name||"UnknownError";var h=g.stack||a.h||"Not available";h.startsWith(e+": "+d)&&(f=h.split("\n"),f.shift(),h=f.join("\n"));f=g.lineNumber||"Not available";g=g.fileName||"Not available";var k=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var l=0;l<a.args.length&&!(k=aj(a.args[l],"params."+l,c,k),500<=k);l++);else if(a.hasOwnProperty("params")&&a.params){var n=a.params;
if("object"===typeof a.params)for(l in n){if(n[l]){var p="params."+l,q=cj(n[l]);c[p]=q;k+=p.length+q.length;if(500<k)break}}else c.params=cj(n)}if(hj.length)for(l=0;l<hj.length&&!(k=aj(hj[l],"params.context."+l,c,k),500<=k);l++);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c["device.vendor"]=navigator.vendor);l={message:d,name:e,lineNumber:f,fileName:g,stack:h,params:c,sampleWeight:1};c=Number(a.columnNumber);isNaN(c)||(l.lineNumber=l.lineNumber+":"+c);if("IGNORED"===a.level)a=0;else a:{a=Xi();
c=u(a.i);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.wk)){a=d.weight;break a}a=u(a.h);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Da(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Ui);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.na[l.name])for(e=u(c.na[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=d[g+
1];l.message=c.wa(f);break}l.params||(l.params={});a=Xi();l.params["params.errorServiceSignature"]="msg="+a.i.length+"&cb="+a.h.length;l.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&(l.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));window.yterr&&"function"===typeof window.yterr&&window.yterr(l);if(0!==l.sampleWeight&&!dj.has(l.message)){"ERROR"===b?(Yi.O("handleError",l),Q("record_app_crashed_web")&&0===gj&&1===l.sampleWeight&&
(gj++,Ti("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),fj++):"WARNING"===b&&Yi.O("handleWarning",l);if(Q("kevlar_gel_error_routing")){c=b;b:{a=u(ij);for(d=a.next();!d.done;d=a.next())if(og(d.value.toLowerCase())){a=!0;break b}a=!1}if(a)a=void 0;else{d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);a=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==a.length&&(1!==a.length||isNaN(Number(a[0]))?2!==a.length||isNaN(Number(a[0]))||isNaN(Number(a[1]))||(d.lineNumber=Number(a[0]),
...
e=I("SERVER_NAME",void 0);f=I("SERVER_VERSION",void 0);e&&f&&(d.kvPairs.push({key:"server.name",value:e}),d.kvPairs.push({key:"server.version",value:f}));a={errorMetadata:d,stackTrace:c,logMessage:a}}a&&(Ti("clientError",a),Tg())}if(!Q("suppress_error_204_logging")){a=l.params||{};b={urlParams:{a:"logerror",t:"jserror",type:l.name,msg:l.message.substr(0,250),line:l.lineNumber,level:b,"client.name":a.name},postParams:{url:I("PAGE_NAME",window.location.href),file:l.fileName},method:"POST"};a.version&&
(b["client.version"]=a.version);if(b.postParams){l.stack&&(b.postParams.stack=l.stack);c=u(Object.keys(a));for(d=c.next();!d.done;d=c.next())d=d.value,b.postParams["client."+d]=a[d];if(a=I("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(c=u(Object.keys(a)),d=c.next();!d.done;d=c.next())d=d.value,b.postParams[d]=a[d];a=I("SERVER_NAME",void 0);c=I("SERVER_VERSION",void 0);a&&c&&(b.postParams["server.name"]=a,b.postParams["server.version"]=c)}hg(I("ECATCHER_REPORT_HOST","")+"/error_204",b)}dj.add(l.message);
ej++}}}
function lj(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];a.args||(a.args=[]);a.args.push.apply(a.args,c instanceof Array?c:fa(u(c)))}
;function mj(a){a&&(a.dataset?a.dataset[nj("loaded")]="true":a.setAttribute("data-loaded","true"))}
function oj(a,b){return a?a.dataset?a.dataset[nj(b)]:a.getAttribute("data-"+b):null}
var pj={};function nj(a){return pj[a]||(pj[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var qj=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,rj=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function sj(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(qj,""),c=c.replace(rj,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else tj(a,b,c)}
function tj(a,b,c){c=void 0===c?null:c;var d=uj(a),e=document.getElementById(d),f=e&&oj(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=zg(d,b),b=""+Ka(b),vj[b]=f),g||(e=wj(a,d,function(){oj(e,"loaded")||(mj(e),Cg(d),R(Pa(Dg,d),0))},c)))}
function wj(a,b,c,d){d=void 0===d?null:d;var e=Cc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function xj(a){a=uj(a);var b=document.getElementById(a);b&&(Dg(a),b.parentNode.removeChild(b))}
function yj(a,b){if(a&&b){var c=""+Ka(b);(c=vj[c])&&Bg(c)}}
function uj(a){var b=document.createElement("a");Ob(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Rb(a)}
var vj={};var zj=[],Aj=!1;function Bj(){if(!Q("disable_ad_status_on_html5_clients")&&(!Q("condition_ad_status_fetch_on_consent_cookie_html5_clients")||Vc.get("CONSENT","").startsWith("YES+"))&&"1"!=hb()){var a=function(){Aj=!0;"google_ad_status"in window?df("DCLKSTAT",1):df("DCLKSTAT",2)};
try{sj("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}zj.push(Bf(function(){if(!(Aj||"google_ad_status"in window)){try{yj("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Aj=!0;df("DCLKSTAT",3)}},5E3))}}
function Cj(){return parseInt(I("DCLKSTAT",0),10)}
;function Dj(){this.i=!1;this.h=null}
Dj.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.i=!0,sj(b,function(){g.i=!1;var h=0<=b.indexOf("/th/");(h?window.trayride:window.botguard)?Ej(g,c,d,f,h):(xj(b),jj(new V("Unable to load Botguard","from "+b)))},e)):a&&(e=Cc(document,"SCRIPT"),e.textContent=a,e.nonce=Ca(),document.head.appendChild(e),document.head.removeChild(e),((a=a.includes("trayride"))?window.trayride:window.botguard)?Ej(this,c,d,f,a):jj(Error("Unable to load Botguard from JS")))};
function Ej(a,b,c,d,e){e=e?window.trayride.ad:window.botguard.bg;if(d)try{a.h=new e(b,c?function(){return c(b)}:Ga)}catch(f){jj(f)}else{try{a.h=new e(b)}catch(f){jj(f)}c&&c(b)}}
Dj.prototype.dispose=function(){this.h=null};var Fj=new Dj;function Gj(){return!!Fj.h}
function Hj(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Fj.h?Fj.h.hot?Fj.h.hot(void 0,void 0,a):Fj.h.invoke(void 0,void 0,a):null}
;var Ij={Lb:29434,Nb:3611,Be:3854,Tf:42993,Di:4724,nj:96370,gb:27686,hb:85013,ib:23462,kb:42016,lb:62407,mb:26926,jb:43781,nb:51236,ob:79148,pb:50160,qb:77504,Cb:87907,Db:18630,Eb:54445,Fb:80935,Gb:105675,Hb:37521,Ib:47786,Jb:98349,Kb:6827,Mb:7282,Qb:32276,Pb:76278,Rb:93911,Sb:106531,Tb:27259,Ub:27262,Vb:27263,Xb:21759,Yb:27107,Zb:62936,ac:49568,cc:38408,dc:80637,ec:68727,fc:68728,hc:80353,ic:80356,jc:74610,kc:45707,lc:83962,mc:83970,nc:46713,oc:89711,pc:74612,qc:93265,sc:74611,uc:113533,wc:93252,
...
mj:5E4,oj:47355,pj:47356,qj:37935,rj:45521,sj:21760,tj:83769,uj:49977,vj:49974,wj:93497,xj:93498,yj:34325,zj:115803,Aj:100081,Bj:35309,Cj:68314,Dj:25602,Ej:100339,Fj:59018,Gj:18248,Hj:50625,Ij:9729,Jj:37168,Kj:37169,Lj:21667,Mj:16749,Nj:18635,Oj:39305,Pj:18046,Qj:53969,Rj:8213,Sj:93926,Tj:102852,Uj:110099,Vj:22678,Wj:69076,Yj:100856,Zj:17736,ak:3832,bk:55759,ck:64031,dk:93044,ek:93045,fk:34388,gk:17657,hk:17655,ik:39579,jk:39578,kk:77448,lk:8196,mk:11357,nk:69877,pk:8197,qk:82039};function Jj(a,b,c){N.call(this);var d=this;c=c||I("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.C="*";this.l=c;this.sessionId=null;this.channel="widget";this.F=!!a;this.A=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.F&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(Jj,N);Jj.prototype.sendMessage=function(a,b){var c=b||this.j;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.C)}catch(e){jf(e)}}};
Jj.prototype.B=function(){window.removeEventListener("message",this.A);N.prototype.B.call(this)};function Kj(){var a=this.i=new Jj(!!I("WIDGET_ID_ENFORCE")),b=E(this.Va,this);a.m=b;a.o=null;this.i.channel="widget";if(a=I("WIDGET_ID"))this.i.sessionId=a;this.l=[];this.m=!1;this.u={}}
m=Kj.prototype;m.Va=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.u[a]||"onReady"==a||(this.addEventListener(a,Lj(this,a)),this.u[a]=!0)):this.oa(a,b,c)};
m.oa=function(){};
function Lj(a,b){return E(function(c){this.sendMessage(b,c)},a)}
...
m.dispose=function(){this.i=null};function Nj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
function Qj(a,b,c,d){if(D(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function Rj(a){Kj.call(this);this.h=a;this.j=[];this.addEventListener("onReady",E(this.Sa,this));this.addEventListener("onVideoProgress",E(this.bb,this));this.addEventListener("onVolumeChange",E(this.cb,this));this.addEventListener("onApiChange",E(this.Wa,this));this.addEventListener("onPlaybackQualityChange",E(this.Ya,this));this.addEventListener("onPlaybackRateChange",E(this.Za,this));this.addEventListener("onStateChange",E(this.ab,this));this.addEventListener("onWebglSettingsChanged",E(this.eb,
this))}
v(Rj,Kj);m=Rj.prototype;m.oa=function(a,b,c){if(this.h.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Nj(a)){var d=b;if(D(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Pj.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Oj.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Qj.apply(window,d)}d=e}b.length=1;b[0]=d}this.h.handleExternalCall(a,b,c);Nj(a)&&Mj(this,this.ja())}};
...
this.h.getVideoUrl());this.h.getVideoContentRect&&(a.videoContentRect=this.h.getVideoContentRect());this.h.getProgressState&&(a.progressState=this.h.getProgressState());this.h.getPlaylist&&(a.playlist=this.h.getPlaylist());this.h.getPlaylistIndex&&(a.playlistIndex=this.h.getPlaylistIndex());this.h.getStoryboardFormat&&(a.storyboardFormat=this.h.getStoryboardFormat());Mj(this,a)};
m.Ya=function(a){Mj(this,{playbackQuality:a})};
m.Za=function(a){Mj(this,{playbackRate:a})};
...
m.cb=function(){Mj(this,{muted:this.h.isMuted(),volume:this.h.getVolume()})};
m.bb=function(a){a={currentTime:a,videoBytesLoaded:this.h.getVideoBytesLoaded(),videoLoadedFraction:this.h.getVideoLoadedFraction(),currentTimeLastUpdated_:F()/1E3,playbackRate:this.h.getPlaybackRate(),mediaReferenceTime:this.h.getMediaReferenceTime()};this.h.getProgressState&&(a.progressState=this.h.getProgressState());Mj(this,a)};
m.eb=function(){var a={sphericalProperties:this.h.getSphericalProperties()};Mj(this,a)};
m.dispose=function(){Kj.prototype.dispose.call(this);for(var a=0;a<this.j.length;a++){var b=this.j[a];this.h.removeEventListener(b.eventType,b.listener)}this.j=[]};function Sj(a){a=void 0===a?!1:a;N.call(this);this.i=new P(a);xd(this,Pa(vd,this.i))}
G(Sj,N);Sj.prototype.subscribe=function(a,b,c){return this.h?0:this.i.subscribe(a,b,c)};
Sj.prototype.l=function(a,b){this.h||this.i.O.apply(this.i,arguments)};function Tj(a,b,c){Sj.call(this);this.j=a;this.destination=b;this.id=c}
v(Tj,Sj);Tj.prototype.P=function(a,b){this.h||this.j.P(this.destination,this.id,a,b)};
Tj.prototype.B=function(){this.destination=this.j=null;Sj.prototype.B.call(this)};function Uj(a,b,c){N.call(this);this.i=a;this.l=c;this.o=vf(window,"message",E(this.m,this));this.j=new Tj(this,a,b);xd(this,Pa(vd,this.j))}
v(Uj,N);Uj.prototype.P=function(a,b,c,d){this.h||a!=this.i||(a={id:b,command:c},d&&(a.data=d),this.i.postMessage(ne(a),this.l))};
Uj.prototype.m=function(a){var b;if(b=!this.h)if(b=a.origin==this.l)a:{b=this.i;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.j,c.h||c.l("command",b.command,b.data,a.origin))}};
Uj.prototype.B=function(){wf(this.o);this.i=null;N.prototype.B.call(this)};function Vj(){var a=jb(Wj),b;return Ae(new O(function(c,d){a.onSuccess=function(e){Zf(e)?c(e):d(new Xj("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Xj("Unknown request error","net.unknown",e))};
a.onTimeout=function(e){d(new Xj("Request timed out","net.timeout",e))};
b=hg("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Be&&b.abort();
return ye(c)})}
function Xj(a,b,c){Sa.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
v(Xj,Sa);function Yj(){this.i=0;this.h=null}
Yj.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.h),te(a)?a:Zj(a)):2===this.i&&b?(a=b.call(c,this.h),te(a)?a:ak(a)):this};
Yj.prototype.getValue=function(){return this.h};
Yj.prototype.$goog_Thenable=!0;function ak(a){var b=new Yj;a=void 0===a?null:a;b.i=2;b.h=void 0===a?null:a;return b}
function Zj(a){var b=new Yj;a=void 0===a?null:a;b.i=1;b.h=void 0===a?null:a;return b}
;function bk(a){Sa.call(this,a.message||a.description||a.name);this.isMissing=a instanceof ck;this.isTimeout=a instanceof Xj&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Be}
v(bk,Sa);bk.prototype.name="BiscottiError";function ck(){Sa.call(this,"Biscotti ID is missing from server")}
v(ck,Sa);ck.prototype.name="BiscottiMissingError";var Wj={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},dk=null;
function Lf(){if(Q("disable_biscotti_fetch_on_html5_clients"))return ye(Error("Fetching biscotti ID is disabled."));if(Q("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!Vc.get("CONSENT","").startsWith("YES+"))return ye(Error("User has not consented - not fetching biscotti id."));if("1"==hb())return ye(Error("Biscotti ID is not available in private embed mode"));dk||(dk=Ae(Vj().then(ek),function(a){return fk(2,a)}));
return dk}
function ek(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new ck;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new ck;a=a.id;Mf(a);dk=Zj(a);gk(18E5,2);return a}
function fk(a,b){var c=new bk(b);Mf("");dk=ak(c);0<a&&gk(12E4,a-1);throw c;}
function gk(a,b){R(function(){Ae(Vj().then(ek,function(c){return fk(b,c)}),Ga)},a)}
function hk(){try{var a=B("yt.ads.biscotti.getId_");return a?a():Lf()}catch(b){return ye(b)}}
;function ik(a){if("1"!=hb()){a&&Kf();try{hk().then(function(){},function(){}),R(ik,18E5)}catch(b){hf(b)}}}
;var jk=F().toString();
function kk(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=F();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(jk)for(a=1,b=0;b<jk.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^jk.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var lk,mk=z.ytLoggingDocDocumentNonce_;mk||(mk=kk(),Qa("ytLoggingDocDocumentNonce_",mk));lk=mk;var nk={Od:0,Ob:1,Wb:2,Tg:3,Qd:4,Xj:5,Ih:6,Ji:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function ok(a){this.h=a}
function pk(a){return new ok({trackingParams:a})}
ok.prototype.getAsJson=function(){var a={};void 0!==this.h.trackingParams?a.trackingParams=this.h.trackingParams:(a.veType=this.h.veType,void 0!==this.h.veCounter&&(a.veCounter=this.h.veCounter),void 0!==this.h.elementIndex&&(a.elementIndex=this.h.elementIndex));void 0!==this.h.dataElement&&(a.dataElement=this.h.dataElement.getAsJson());void 0!==this.h.youtubeData&&(a.youtubeData=this.h.youtubeData);return a};
ok.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
ok.prototype.isClientVe=function(){return!this.h.trackingParams&&!!this.h.veType};function qk(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function rk(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function sk(a){return I(rk(void 0===a?0:a),void 0)}
A("yt_logging_screen.getRootVeType",sk,void 0);function tk(a){return(a=sk(void 0===a?0:a))?new ok({veType:a,youtubeData:void 0}):null}
function uk(){var a=I("csn-to-ctt-auth-info");a||(a={},df("csn-to-ctt-auth-info",a));return a}
function vk(a){a=void 0===a?0:a;var b=I(qk(a));if(!b&&!I("USE_CSN_FALLBACK",!0))return null;b||0!=a||(b="UNDEFINED_CSN");return b?b:null}
A("yt_logging_screen.getCurrentCsn",vk,void 0);function wk(a,b,c){var d=uk();(c=vk(c))&&delete d[c];b&&(d[a]=b)}
function xk(a){return uk()[a]}
A("yt_logging_screen.getCttAuthInfo",xk,void 0);function yk(a,b,c,d){c=void 0===c?0:c;if(a!==I(qk(c))||b!==I(rk(c)))wk(a,d,c),df(qk(c),a),df(rk(c),b),b=function(){setTimeout(function(){a&&ch("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:lk,clientScreenNonce:a},Si)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
A("yt_logging_screen.setCurrentScreen",yk,void 0);function zk(a){vh.call(this,1,arguments);this.csn=a}
v(zk,vh);var Eh=new wh("screen-created",zk),Ak=[],Ck=Bk,Dk=0;function Ek(a,b,c,d){c={csn:b,parentVe:c.getAsJson(),childVes:Xa(d,function(f){return f.getAsJson()})};
d=u(d);for(var e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(fb(e)||!e.trackingParams&&!e.veType)&&jj(Error("Child VE logged with no data"));d={D:xk(b),M:b};"UNDEFINED_CSN"==b?Fk("visualElementAttached",c,d):a?ch("visualElementAttached",c,a,d):Ti("visualElementAttached",c,d)}
function Bk(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return uc(b)}
function Fk(a,b,c){Ak.push({payloadName:a,payload:b,options:c});Dk||(Dk=Fh())}
function Gh(a){if(Ak){for(var b=u(Ak),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,ch(c.payloadName,c.payload,null,c.options));Ak.length=0}Dk=0}
;function Gk(){this.i=new Set;this.h=new Set;this.j=new Map}
Gk.prototype.clear=function(){this.i.clear();this.h.clear();this.j.clear()};
Ha(Gk);function Hk(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Ik(a)||c.some(function(e){return!Ik(e)}))throw Error("Only objects may be merged.");
c=u(c);for(d=c.next();!d.done;d=c.next())Jk(a,d.value);return a}
function Jk(a,b){for(var c in b)if(Ik(b[c])){if(c in a&&!Ik(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});Jk(a[c],b[c])}else if(Kk(b[c])){if(c in a&&!Kk(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Lk(a[c],b[c])}else a[c]=b[c];return a}
function Lk(a,b){for(var c=u(b),d=c.next();!d.done;d=c.next())d=d.value,Ik(d)?a.push(Jk({},d)):Kk(d)?a.push(Lk([],d)):a.push(d);return a}
function Ik(a){return"object"===typeof a&&!Array.isArray(a)}
function Kk(a){return"object"===typeof a&&Array.isArray(a)}
;function Mk(a,b){vh.call(this,1,arguments)}
v(Mk,vh);function Nk(a,b){vh.call(this,1,arguments)}
v(Nk,vh);var Ok=new wh("aft-recorded",Mk),Pk=new wh("timing-sent",Nk);var Qk=window;function Rk(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var Sk=Qk.performance||Qk.mozPerformance||Qk.msPerformance||Qk.webkitPerformance||new Rk;var Tk=!1;E(Sk.clearResourceTimings||Sk.webkitClearResourceTimings||Sk.mozClearResourceTimings||Sk.msClearResourceTimings||Sk.oClearResourceTimings||Ga,Sk);function Uk(a){var b=Vk(a);if(b.aft)return b.aft;a=I((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function Wk(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Qa("ytcsi."+(a||"")+"data_",b));return b}
function Xk(a){a=Wk(a);a.info||(a.info={});return a.info}
function Vk(a){a=Wk(a);a.tick||(a.tick={});return a.tick}
function Yk(a){var b=Wk(a).nonce;b||(b=kk(),Wk(a).nonce=b);return b}
function Zk(a){var b=Vk(a||""),c=Uk(a);c&&!Tk&&(Bh(Ok,new Mk(Math.round(c-b._start),a)),Tk=!0)}
;function $k(){var a=B("ytcsi.debug");a||(a=[],A("ytcsi.debug",a,void 0),A("ytcsi.reference",{},void 0));return a}
function al(a){a=a||"";var b=B("ytcsi.reference");b||($k(),b=B("ytcsi.reference"));if(b[a])return b[a];var c=$k(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var bl=z.ytLoggingLatencyUsageStats_||{};A("ytLoggingLatencyUsageStats_",bl,void 0);function cl(){this.h=0}
function dl(){cl.h||(cl.h=new cl);return cl.h}
cl.prototype.tick=function(a,b,c){el(this,"tick_"+a+"_"+b)||Ti("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
cl.prototype.info=function(a,b){var c=Object.keys(a).join("");el(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,Ti("latencyActionInfo",c))};
cl.prototype.span=function(a,b){var c=Object.keys(a).join("");el(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,Ti("latencyActionSpan",a))};
function el(a,b){bl[b]=bl[b]||{count:0};var c=bl[b];c.count++;c.time=S();a.h||(a.h=Cf(function(){var d=S(),e;for(e in bl)bl[e]&&6E4<d-bl[e].time&&delete bl[e];a&&(a.h=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new V("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||jj(c)),!0):!1}
;var Z={},fl=(Z.ad_allowed="adTypesAllowed",Z.yt_abt="adBreakType",Z.ad_cpn="adClientPlaybackNonce",Z.ad_docid="adVideoId",Z.yt_ad_an="adNetworks",Z.ad_at="adType",Z.aida="appInstallDataAgeMs",Z.browse_id="browseId",Z.p="httpProtocol",Z.t="transportProtocol",Z.cpn="clientPlaybackNonce",Z.ccs="creatorInfo.creatorCanaryState",Z.csn="clientScreenNonce",Z.docid="videoId",Z.GetHome_rid="requestIds",Z.GetSearch_rid="requestIds",Z.GetPlayer_rid="requestIds",Z.GetWatchNext_rid="requestIds",Z.GetBrowse_rid=
...
"requestIds",Z.GetTrending_rid="requestIds",Z.GetMusicSearchSuggestions_rid="requestIds",Z.REQUEST_ID="requestIds",Z),gl="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),hl={},il=(hl.ccs="CANARY_STATE_",hl.mver="MEASUREMENT_VERSION_",
hl.pis="PLAYER_INITIALIZED_STATE_",hl.yt_pt="LATENCY_PLAYER_",hl.pa="LATENCY_ACTION_",hl.yt_vst="VIDEO_STREAM_TYPE_",hl),jl="all_vc ap aq c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function kl(a){return!!I("FORCE_CSI_ON_GEL",!1)||Q("csi_on_gel")||!!Wk(a).useGel}
function ll(a){a=Wk(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
;function ml(a,b,c){if(null!==b)if(Xk(c)[a]=b,kl(c)){var d=b;b=ll(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in fl){b=fl[a];0<=Va(gl,b)&&(d=!!d);a in il&&"string"===typeof d&&(d=il[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Hk({},e)}else 0<=Va(jl,a)||jj(new V("Unknown label logged with GEL CSI",
a)),f=void 0;f&&kl(c)&&(b=al(c||""),Hk(b.info,f),b=ll(c),b.gelInfos||(b.gelInfos={}),Hk(b.gelInfos,f),c=Yk(c),dl().info(f,c))}else al(c||"").info[a]=b}
function nl(a,b,c){var d=Vk(c);if(Q("use_first_tick")&&ol(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;Sk.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),Sk.mark(e))}e=b||S();d[a]=e;e=ll(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||S();if(kl(c)){al(c||"").tick[a]=b||S();e=Yk(c);if("_start"===a){var f=dl();el(f,"baseline_"+e)||Ti("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else dl().tick(a,e,b);Zk(c);e=!0}else e=!1;if(!e){if(!B("yt.timing."+(c||"")+"pingSent_")&&
(f=I((c||"")+"TIMING_ACTION",void 0),e=Vk(c),B("ytglobal.timing"+(c||"")+"ready_")&&f&&ol("_start")&&Uk(c)))if(Zk(c),c)pl(c);else{f=!0;var g=I("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&pl(c)}al(c||"").tick[a]=b||S()}return d[a]}
function ol(a,b){var c=Vk(b);return a in c}
function pl(a){if(!kl(a)){var b=Vk(a),c=Xk(a),d=b._start,e=I("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:I((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Uk(a);var h=Vk(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&Xk(a).yt_pvis&&"youtube"===e&&(ml("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var n in c)"_"!==n.charAt(0)&&(f[n]=c[n]);b.ps=S();n={};e=[];for(var p in b)"_"!==p.charAt(0)&&(k=Math.round(b[p]-d),n[p]=k,e.push(p+"."+k));f.rt=
e.join(",");b=!!c.ap;c="";for(var q in f)f.hasOwnProperty(q)&&(c+="&"+q+"="+f[q]);f="/csi_204?"+c.substring(1);window.navigator&&window.navigator.sendBeacon&&(b||Q("always_send_csi_204_with_beacon"))?ug(f):rg(f);A("yt.timing."+(a||"")+"pingSent_",!0,void 0);Bh(Pk,new Nk(n.aft+(Number(g)||0),a))}}
var ql=window;ql.ytcsi&&(ql.ytcsi.info=ml,ql.ytcsi.tick=nl);function rl(){this.l=[];this.u=[];this.h=[];this.i=new Set;this.m=new Map}
function sl(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.i.has(c)&&a.j&&a.j();var g=vk(c),h=tk(c);g&&h&&(d.csn=g,(null===(e=d.response)||void 0===e?0:e.trackingParams)&&Ek(a.client,g,h,[pk(d.response.trackingParams)]),(null===(f=d.playerResponse)||void 0===f?0:f.trackingParams)&&Ek(a.client,g,h,[pk(d.playerResponse.trackingParams)]))})}
function tl(a,b,c,d){d=void 0===d?0:d;if(a.i.has(d))a.l.push([b,c]);else{var e=vk(d);c=c||tk(d);e&&c&&Ek(a.client,e,c,[b])}}
rl.prototype.clickCommand=function(a){var b=vk();if(!a.clickTrackingParams||!b)return!1;var c=this.client;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";a={csn:b,ve:pk(a.clickTrackingParams).getAsJson(),gestureType:d};d={D:xk(b),M:b};"UNDEFINED_CSN"==b?Fk("visualElementGestured",a,d):c?ch("visualElementGestured",a,c,d):Ti("visualElementGestured",a,d);return!0};
function ul(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){vl(a,b,c);var f=tk(c.layer);if(f){for(var g=u(a.l),h=g.next();!h.done;h=g.next())h=h.value,tl(a,h[0],h[1]||f,c.layer);f=u(a.u);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=vk(g);var l=k[0]||tk(g);h&&l&&(g=a.client,k=k[1],k={csn:h,ve:l.getAsJson(),clientData:k},l={D:xk(h),M:h},"UNDEFINED_CSN"==h?Fk("visualElementStateChanged",k,l):g?ch("visualElementStateChanged",k,g,l):Ti("visualElementStateChanged",
k,l))}}};
vk(c.layer)||a.j();if(c.ta)for(var d=u(c.ta),e=d.next();!e.done;e=d.next())sl(a,e.value,c.layer);else kj(Error("Delayed screen needs a data promise."))}
function vl(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Ta?c.Ta:c.layer;var e=vk(d);d=tk(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));try{var g=a.client,h=f,k=c.sa,l=c.D,n=Ck(),p={csn:n,pageVe:(new ok({veType:b,youtubeData:void 0})).getAsJson()};h&&h.visualElement?p.implicitGesture={parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&jj(new V("newScreen() parent element does not have a VE - rootVe",
b));k&&(p.cloneCsn=k);k={D:l,M:n};g?ch("screenCreated",p,g,k):Ti("screenCreated",p,k);Bh(Eh,new zk(n));var q=n}catch(r){lj(r,{Ak:b,rootVe:d,parentVisualElement:void 0,vk:e,zk:f,sa:c.sa});kj(r);return}yk(q,b,c.layer,c.D);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=Q("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(nk));for(f=b.next();!f.done;f=b.next())if(vk(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,g=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:g},f={D:xk(e),M:e,
Fa:f},"UNDEFINED_CSN"==e?Fk("visualElementHidden",d,f):b?ch("visualElementHidden",d,b,f):Ti("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=q||"");ml("csn",q);Gk.getInstance().clear();d=tk(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(Q("web_mark_root_visible")||Q("music_web_mark_root_visible"))&&(e=q,q=Q("use_default_events_client")?void 0:Si,b={csn:e,ve:d.getAsJson(),eventType:1},f={D:xk(e),M:e},"UNDEFINED_CSN"==e?Fk("visualElementShown",b,f):q?ch("visualElementShown",
b,q,f):Ti("visualElementShown",b,f));a.i["delete"](c.layer||0);a.j=void 0;e=u(a.m);for(q=e.next();!q.done;q=e.next())q=u(q.value),b=q.next().value,q.next().value.has(c.layer)&&d&&tl(a,b,d,c.layer)}
;function wl(a){N.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.za,this)}
v(wl,N);m=wl.prototype;m.start=function(){this.started||this.h||(this.started=!0,this.connection.P("RECEIVING"))};
m.P=function(a,b){this.started&&!this.h&&this.connection.P(a,b)};
m.za=function(a,b,c){if(this.started&&!this.h){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=xl(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=yl(a,c))&&this.P(a,c))}}};
...
m.B=function(){var a=this.connection;a.h||Le(a.i,"command",this.za,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);N.prototype.B.call(this)};function zl(a,b){wl.call(this,b);this.api=a;this.start()}
v(zl,wl);zl.prototype.addEventListener=function(a,b){this.api.addEventListener(a,b)};
zl.prototype.removeEventListener=function(a,b){this.api.removeEventListener(a,b)};
function xl(a,b){switch(a){case "loadVideoById":var c=Pj(b);return[c];case "cueVideoById":return c=Pj(b),[c];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return c=Qj(b),[c];case "cuePlaylist":return c=Qj(b),[c];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey,b.ctrlKey,b.altKey,b.metaKey,b.key,b.code]}return[]}
function yl(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
zl.prototype.ia=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return wl.prototype.ia.call(this,a,b)};
zl.prototype.B=function(){wl.prototype.B.call(this);delete this.api};function Al(){N.call(this);this.i=[]}
v(Al,N);Al.prototype.B=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.Da)}N.prototype.B.call(this)};function Bl(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||jb(b);this.assets=a.assets||{};this.attrs=a.attrs||jb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Bl.prototype.clone=function(){var a=new Bl,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ia(c)?a[b]=jb(c):a[b]=c}return a};var Cl=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Dl(a){a=a||"";if(window.spf){var b=a.match(Cl);spf.style.load(a,b?b[1]:"",void 0)}else El(a)}
function El(a){var b=Fl(a),c=document.getElementById(b),d=c&&oj(c,"loaded");d||c&&!d||(c=Gl(a,b,function(){oj(c,"loaded")||(mj(c),Cg(b),R(Pa(Dg,b),0))}))}
function Gl(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=Kc(a);d.rel="stylesheet";d.href=rb(a).toString();(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function Fl(a){var b=Cc(document,"A");Ob(b,new J(a,Bb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Rb(a)}
;function Hl(a,b,c,d){N.call(this);var e=this;this.F=b;this.webPlayerContextConfig=d;this.fa=!1;this.api={};this.T=this.m=null;this.I=new P;this.i={};this.K=this.Z=this.elementId=this.ga=this.config=null;this.J=!1;this.l=this.A=null;this.aa={};this.Ba=["onReady"];this.lastError=null;this.qa=NaN;this.C={};this.Ca=new Al(this);this.S=0;this.j=this.o=a;xd(this,Pa(vd,this.I));Il(this);Jl(this);xd(this,Pa(vd,this.Ca));c?this.S=R(function(){e.loadNewVideoConfig(c)},0):d&&(Kl(this),Ll(this))}
v(Hl,N);m=Hl.prototype;m.getId=function(){return this.F};
m.loadNewVideoConfig=function(a){if(!this.h){this.S&&(yf(this.S),this.S=0);var b=a||{};b instanceof Bl||(b=new Bl(b));this.config=b;this.setConfig(a);Ll(this);this.isReady()&&Ml(this)}};
function Kl(a){var b,c;a.webPlayerContextConfig?c=a.webPlayerContextConfig.rootElementId:c=a.config.attrs.id;a.elementId=c||a.elementId;"video-player"===a.elementId&&(a.elementId=a.F,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.F:a.config.attrs.id=a.F);(null===(b=a.j)||void 0===b?void 0:b.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
m.setConfig=function(a){var b;this.ga=a;this.config=Nl(a);Kl(this);this.Z||(this.Z=Ol(this,(null===(b=this.config.args)||void 0===b?void 0:b.jsapicallback)||"onYouTubePlayerReady"));this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null===(c=this.config)||void 0===c?0:c.attrs)a=this.config.attrs,(c=a.width)&&this.j&&(this.j.style.width=Mc(Number(c)||c)),(a=a.height)&&this.j&&(this.j.style.height=Mc(Number(a)||a))};
function Ml(a){var b;a.config&&!0!==a.config.loaded&&(a.config.loaded=!0,!a.config.args||"0"!==a.config.args.autoplay&&0!==a.config.args.autoplay&&!1!==a.config.args.autoplay?a.api.loadVideoByPlayerVars(null!==(b=a.config.args)&&void 0!==b?b:null):a.api.cueVideoByPlayerVars(a.config.args))}
function Pl(a){var b=!0,c=Ql(a);c&&a.config&&(a=Rl(a),b=oj(c,"version")===a);return b&&!!B("yt.player.Application.create")}
function Ll(a){if(!a.h&&!a.J){var b=Pl(a);if(b&&"html5"===(Ql(a)?"html5":null))a.K="html5",a.isReady()||Sl(a);else if(Tl(a),a.K="html5",b&&a.l&&a.o)a.o.appendChild(a.l),Sl(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.A=function(){c=!0;var d=Ul(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?Nl(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);Sl(a)};
a.J=!0;b?a.A():(sj(Rl(a),a.A),(b=Vl(a))&&Dl(b),Wl(a)&&!c&&A("yt.player.Application.create",null,void 0))}}}
function Ql(a){var b=yc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function Sl(a){var b;if(!a.h){var c=Ql(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.J=!1,!Ul(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||Xl(a)):a.qa=R(function(){Sl(a)},50)}}
function Xl(a){Il(a);a.fa=!0;var b=Ql(a);if(b){a.m=Yl(a,b,"addEventListener");a.T=Yl(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=Yl(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.m&&a.m(g,a.i[g]);Ml(a);a.Z&&a.Z(a.api);a.I.O("onReady",a.api)}
function Yl(a,b,c){var d=b[c];return function(e){for(var f=[],g=0;g<arguments.length;++g)f[g-0]=arguments[g];try{return a.lastError=null,d.apply(b,f)}catch(h){"sendAbandonmentPing"!==c&&(h.params=c,a.lastError=h,jf(h))}}}
function Il(a){a.fa=!1;if(a.T)for(var b in a.i)a.i.hasOwnProperty(b)&&a.T(b,a.i[b]);for(var c in a.C)a.C.hasOwnProperty(c)&&yf(Number(c));a.C={};a.m=null;a.T=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Jl(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Cg("WATCH_LATER_VIDEO_ADDED",b)});
...
m.addEventListener=function(a,b){var c=this,d=Ol(this,b);if(d){if(!(0<=Va(this.Ba,a)||this.i[a])){var e=Zl(this,a);this.m&&this.m(a,e)}this.I.subscribe(a,d);"onReady"===a&&this.isReady()&&R(function(){d(c.api)},0)}};
m.removeEventListener=function(a,b){if(!this.h){var c=Ol(this,b);c&&Le(this.I,a,c)}};
function Ol(a,b){var c=b;if("string"===typeof b){if(a.aa[b])return a.aa[b];c=function(d){for(var e=[],f=0;f<arguments.length;++f)e[f-0]=arguments[f];(f=B(b))&&f.apply(z,e)};
a.aa[b]=c}return c?c:null}
function Zl(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;z[c]=function(d){var e=R(function(){if(!a.h){a.I.O(b,d);var f=a.C,g=String(e);g in f&&delete f[g]}},0);
gb(a.C,String(e))};
return c}
m.getPlayerType=function(){return this.K||(Ql(this)?"html5":null)};
m.getLastError=function(){return this.lastError};
function Tl(a){a.cancel();Il(a);a.K=null;a.config&&(a.config.loaded=!1);var b=Ql(a);b&&(Pl(a)||!Wl(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.A&&yj(Rl(this),this.A);yf(this.qa);this.J=!1};
m.B=function(){Tl(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){hf(b)}this.aa=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(z[this.i[a]]=null);this.ga=this.config=this.api=null;delete this.o;delete this.j;N.prototype.B.call(this)};
function Wl(a){var b,c;a=null===(c=null===(b=a.config)||void 0===b?void 0:b.args)||void 0===c?void 0:c.fflags;return!!a&&-1!==a.indexOf("player_destroy_old_version=true")}
function Rl(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.jsUrl:(a=a.config.assets)?a.js:""}
function Vl(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.cssUrl:(a=a.config.assets)?a.css:""}
function Ul(a,b){var c;if(a.webPlayerContextConfig)var d=a.webPlayerContextConfig.serializedExperimentFlags;else if(null===(c=a.config)||void 0===c?0:c.args)d=a.config.args.fflags;return"true"===Pf(d||"","&")[b]}
function Nl(a){for(var b={},c=u(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?jb(e):e}return b}
;var $l={},am="player_uid_"+(1E9*Math.random()>>>0);function bm(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?yc(d):d;var e=am+"_"+Ka(d),f=$l[e];if(f&&c)return cm(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Hl(d,e,a,b);$l[e]=f;Cg("player-added",f.api);xd(f,function(){delete $l[f.getId()]});
return f.api}
...
(b=Object.assign({csn:vk()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Rb(d).toString(36),e=e?Wb(e):"",eh(b,e,k||5))}else k=b,e="ST-"+Rb(d).toString(36),k=k?Wb(k):"",eh(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var p=void 0===p?window:p;c=p.location;a=Xb(a,l)+n;a=a instanceof J?a:Gb(a);c.href=Cb(a)}return!0}
;A("yt.setConfig",df,void 0);A("yt.config.set",df,void 0);A("yt.setMsg",lf,void 0);A("yt.msgs.set",lf,void 0);A("yt.logging.errors.log",kj,void 0);
A("writeEmbed",function(){var a=I("PLAYER_CONFIG",void 0);if(!a){var b=I("PLAYER_VARS",void 0);b&&(a={args:b})}ik(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=I("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);if((c=I("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;
if(!c.serializedForcedExperimentIds){var d=window.location.href;-1!=d.indexOf("?")?(d=(d||"").split("#")[0],d=d.split("?",2),d=Tf(1<d.length?d[1]:d[0])):d={};d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}dm=bm(a,c,!1)}else dm=bm(a);dm.addEventListener("onVideoDataChange",gm);a=I("POST_MESSAGE_ID","player");I("ENABLE_JS_API")?fm=new Rj(dm):I("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(em=new Uj(window.parent,a,b),fm=new zl(dm,em.j));Bj()},void 0);
var im=gf(function(){nl("ol");var a=fh.getInstance(),b=!!((ih("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Ad(document.body,"exp-invert-logo"))if(c&&!Ad(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Ad(d,"inverted-hdpi")){var e=yd(d);zd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Ad(document.body,"inverted-hdpi")&&Bd();if(b!=c){b="f"+(Math.floor(119/31)+1);d=ih(b)||0;d=c?d|67108864:
d&-67108865;0==d?delete T[b]:(c=d.toString(16),T[b]=c.toString());c=!0;Q("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in T)d.push(f+"="+encodeURIComponent(String(T[f])));eh(b,d.join("&"),63072E3,a.i,c)}rl.h||(rl.h=new rl);a=rl.h;f=16623;var g=void 0===g?{}:g;Object.values(Ij).includes(f)||(jj(new V("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.l=[];a.u=[];g.ta?ul(a,f,g):vl(a,f,g)}),jm=gf(function(){dm&&
dm.sendAbandonmentPing&&dm.sendAbandonmentPing();
I("PL_ATT")&&Fj.dispose();for(var a=0,b=zj.length;a<b;a++)Ef(zj[a]);zj.length=0;xj("//static.doubleclick.net/instream/ad_status.js");Aj=!1;df("DCLKSTAT",0);wd(fm,em);dm&&(dm.removeEventListener("onVideoDataChange",gm),dm.destroy())});
window.addEventListener?(window.addEventListener("load",im),window.addEventListener("unload",jm)):window.attachEvent&&(window.attachEvent("onload",im),window.attachEvent("onunload",jm));Qa("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Gj);Qa("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Hj);Qa("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Cj);
Qa("yt.player.exports.navigate",B("yt.player.exports.navigate")||hm);Qa("yt.util.activity.init",B("yt.util.activity.init")||Gf);Qa("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||Jf);Qa("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||Hf);}).call(this);
